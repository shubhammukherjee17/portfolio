...
const HeroContent = () => {
  return (
    <>
    <section id="home" className="flex flex-col items-center py-6 sm:py-8 md:py-12 lg:py-16 xl:py-20 px-3 sm:px-4 md:px-6 lg:px-8 transition-all duration-700 ease-in-out">
      <div className="relative mb-4 sm:mb-6 md:mb-8 animate-float">
        <div className="size-20 sm:size-24 md:size-28 lg:size-32 xl:size-36 rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 dark:from-blue-600 dark:via-purple-600 dark:to-pink-600 shadow-2xl dark:shadow-blue-500/20 transition-all duration-700 ease-in-out hover:scale-110 hover:shadow-3xl hover:shadow-purple-500/30 overflow-hidden">
          <Image
        ...
        <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 size-5 sm:size-6 md:size-8 bg-green-500 dark:bg-green-400 rounded-full flex items-center justify-center shadow-lg dark:shadow-green-400/30 transition-all duration-300">
          <div className="size-2 sm:size-3 md:size-4 bg-white rounded-full animate-pulse"></div>
        </div>
      </div>
      
      <h3 className="text-black/80 dark:text-white/90 leading-tight text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold transition-all duration-700 ease-in-out animate-slide-up text-center">
        Full Stack Developer
      </h3>
      <h1 className="text-black/80 dark:text-white/90 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[5.4rem] font-bold transition-all duration-700 ease-in-out animate-slide-up-delay text-center leading-tight mb-3 sm:mb-4">
        Shubham Mukherjee
      </h1>
      <p className="text-black/60 dark:text-white/70 text-sm sm:text-base md:text-lg lg:text-xl mb-5 sm:mb-6 md:mb-8 text-center max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-2xl xl:max-w-3xl transition-all duration-700 ease-in-out animate-fade-in px-2 sm:px-4">
        Passionate about creating <span className="font-bold text-blue-600 dark:text-blue-400 transition-colors duration-300">innovative solutions</span> and 
        <span className="font-bold text-purple-600 dark:text-purple-400 transition-colors duration-300"> beautiful user experiences</span>
      </p>
      
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 animate-slide-up-delay-2 w-full max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-xl mx-auto justify-center">
        <WrapButton 
          href="#projects" 
          className="transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25 active:scale-95 w-full sm:w-auto md:w-auto lg:w-auto xl:w-auto"
        >
          <Eye size={14} />
          View Projects
        </WrapButton>
      ...
      <svg
        ...
        className="mt-6 sm:mt-8 mb-6 sm:mb-8 fill-black/70 dark:fill-white/80 transition-all duration-700 ease-in-out animate-draw-svg sm:w-[100px] sm:h-[50px]"
      >
    ...
    {/* Background Images - Hidden on mobile for performance */}
    <Image 
      className="absolute left-8 sm:left-16 lg:left-24 top-60 sm:top-72 lg:top-80 h-[400px] sm:h-[500px] lg:h-[700px] opacity-5 sm:opacity-10 dark:opacity-5 transition-all duration-700 ease-in-out hidden sm:block" 
    ...
    />
    <Image 
      className="absolute right-8 sm:right-16 lg:right-24 top-60 sm:top-72 lg:top-80 h-[300px] sm:h-[400px] lg:h-[500px] opacity-5 sm:opacity-10 dark:opacity-5 transition-all duration-700 ease-in-out hidden sm:block" 
