...
const NavPart2 = () => {
  return (
    <div className="flex gap-3 items-center">
      ...
      >
        <svg viewBox="0 0 438.549 438.549" className="size-5 text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors duration-300">
      ...
      >
        <svg className="size-4 fill-current text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors duration-300" height="23" viewBox="0 0 1200 1227" width="23" xmlns="http://www.w3.org/2000/svg">
